...
export function renderHeroImage() {
  ...
  <div class="relative rounded-3xl bg-black border border-white/10 overflow-hidden shadow-2xl min-h-[380px] lg:min-h-0">
    <img src="${profile.mainImage}" alt="${profile.name} - Principal" class="absolute inset-0 w-full h-full object-cover object-[50%_36%] grayscale-[10%] hover:grayscale-0 transition duration-700">
  </div>`;
}
